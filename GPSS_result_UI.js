// ==UserScript==
// @name         TIPO 專利內文現代化重構 (V4.0 面板修正與 PiP 相容版)
// @namespace    http://tampermonkey.net/
// @version      4.0
// @description  修正書目面板收合、PiP 自動降級至獨立視窗 (V3.6 模式)
// @author       Gemini
...
(function() {
    ...
    const setupViewerContent = (win, imgSrc) => {
        ...
        win.document.body.innerHTML = `
            <div id="sidebar">
                ...
                <button id="reset" class="btn" style="font-size:10px">RE</button>
            </div>
    ...
    const reconstructUI = () => {
        ...
        const navAnchor = document.createElement('div');
        navAnchor.className = 'action-panel';
        navAnchor.innerHTML = '<span style="font-size:12px; font-weight:bold; color:#666; width:100%;">快速導覽操作：</span>';
        ...
        wrapper.innerHTML = `
            ...
            <div id="main-content-area">
                <div id="cards-container">
                    ...
                    <div id="right-column-stack" style="display: ${claimsContent || navAnchor.children.length > 1 ? 'flex' : 'none'};">
                        <div id="nav-target-box"></div>
                        <div class="patent-card" style="flex:1; display: ${claimsContent ? 'flex' : 'none'};"><div class="card-header">專利範圍</div><div class="card-body">${claimsContent}</div></div>
                    </div>
                </div>
        ...
        document.getElementById('nav-target-box').appendChild(navAnchor);
